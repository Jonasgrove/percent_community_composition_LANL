...
species_comp <- function(num_species, classification){
  ...
  algae52_tops[num_species + 1, c(classification, "percent_community")] <- c("Unclassified", remaining) 
  ...
  # calculate and assign remaining percent community
  remaining <- 100 - percent_selected
  algae53_tops[num_species + 1, c(classification, "percent_community")] <- c("Unclassified", remaining) 
  ...
  # calculate and assign remaining percent community
  remaining <- 100 - percent_selected
  algae114_tops[num_species + 1, c(classification, "percent_community")] <- c("Unclassified", remaining) 
  ...
  # calculate and assign remaining percent community
  remaining <- 100 - percent_selected
  algae115_tops[num_species + 1, c(classification, "percent_community")] <- c("Unclassified", remaining) 
  ...
  ggplot(all_ponds, aes_string(fill=classification, y="percent_community", x="pond")) + 
    ...
    scale_fill_manual(values=c("#4FC601", "#0000A6", "#ffff00", "#1ce6ff", "#860909", "#b903aa", "#0086ed", "#ff913f", "#d790ff", "#72418f", "#324e72", "#A77500", "#646764"))
  
}

colors <- c("#4FC601", "#0000A6", "#ffff00", "#1ce6ff", "#63ffac", "#b903aa", "#0086ed", "#ff913f", "#d790ff", "#72418f", "#324e72", "#00fecf", "#646764")

bins <- 31
classy <- "Phylum"
species_comp(bins, classy)
