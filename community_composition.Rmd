...
graphing_function <- function(num_bins, classification, annotated_only){
...
inputPanel(
  ...
  selectInput("n_species", label = "Number of Bins:",
              ...
              selected = 3))
  selectInput("annotated_only", "Show Annotated Only",
              choices = c(TRUE, FALSE), 
              selected = FALSE)

renderPlot({
  graphing_function(as.numeric(input$n_species), input$classification, input$annotated_only)
})
```
